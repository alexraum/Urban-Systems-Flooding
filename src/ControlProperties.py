...
def plot_data(daterange, list1, list2, linecolor, fig_width,
    ...
    ax.set_title('Property Values vs. Time in Zone ' + zone + 
                 '\n(Unaffected By Flooding)', size=title_size)
...
df_vals = pd.read_csv('control_property_vals_vs_time.csv', parse_dates=True, index_col='DATE')
